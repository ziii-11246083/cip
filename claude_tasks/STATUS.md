...
| 05A | RAG 評測資料契約、離線 runner 與 artifacts | READY_FOR_CODEX_REVIEW | PASS |
| 05B | RAG baseline 比較與 regression gate | READY_FOR_CODEX_REVIEW | PASS |
| 06 | RAG 管理 endpoints 權限 | READY_FOR_CODEX_REVIEW | PASS |
| 07 | 詐騙檢測真實化與結構化證據 | READY_FOR_CODEX_REVIEW | PASS |
| 08 | 系統功能、UML、資料字典一致性 | READY_FOR_CODEX_REVIEW | PASS |
| 09 | 資產同步架構與資料模型（不接 provider） | READY_FOR_CODEX_REVIEW | PASS |
| 10 | 公開錢包地址唯讀同步 MVP | READY_FOR_CODEX_REVIEW | PASS |
| 11 | Paper Trading 情境壓力測試 | READY_FOR_CODEX_REVIEW | PASS |
| 12 | 商業數字、競品與 GitHub 複評證據 | READY_FOR_CODEX_REVIEW | PASS |
